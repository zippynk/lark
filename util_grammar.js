...
var grammar = {
    ...
    {"name": "charL", "symbols": [" string$3"], "postprocess":  function(d){return "lark.lit('"+"$"+"')";} },
    {"name": " string$4", "symbols": [{"literal":"\\"}, {"literal":"="}], "postprocess": function joiner(d) {
        return d.join('');
    }},
    {"name": "charL", "symbols": [" string$4"], "postprocess":  function(d){return "lark.lit('"+"="+"')";} },
    {"name": " string$5", "symbols": [{"literal":"\\"}, {"literal":"n"}], "postprocess": function joiner(d) {
        return d.join('');
    }},
    {"name": "charL", "symbols": [" string$5"], "postprocess":  function(d){return "lark.lit('"+"\\n"+"')";} },
    {"name": "charL", "symbols": [{"literal":"'"}], "postprocess":  function(d){return 'lark.lit("\'")';} },
    ...
    {"name": "charR", "symbols": [{"literal":"'"}], "postprocess":  function(d){return '"\'"';} },
    {"name": " ebnf$1", "symbols": []},
